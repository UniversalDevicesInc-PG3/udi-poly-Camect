# udi-poly-Camect — XML validation and PG3 release artifacts (tag + per-track zips).
#
# PG3 release flow (clean tree; not detached HEAD):
#   1. Bump nodes/__init__.py VERSION; commit (and update README.md).
...
# Run from this directory, or: make -C /path/to/udi-poly-Camect release
